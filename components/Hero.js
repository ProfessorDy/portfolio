...
const Hero = () => {
    return (
        <section className='relative'>
            <Image
                src={HeroImage}
                className=' max-h-64 sm:max-h-[37.5rem] lg:max-h-[49.875rem] object-cover '
            />
            <article className='bg-very-light-grey max-w-[27.8125rem] sm:absolute bottom-0 left-0  sm:pt-14  sm:pr-14'>
